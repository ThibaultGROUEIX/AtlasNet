...
parser.add_argument('--model_preTrained_AE', type=str, default = 'trained_models/ae_atlas_25.pth',  help='model path')
...
parser.add_argument('--fix_decoder', type=bool, default = True   ,  help='size of the bottleneck')
